...
public class WDCKPSPublicSoap
{
    ...
    public WDCKPSPublicSoap(){}

    public WDCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public WDCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        WDCExtendedSoapSerializationEnvelope envelope= new WDCExtendedSoapSerializationEnvelope(WDCExtendedSoapSerializationEnvelope.VER11);
