...
public class WDCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(WDCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new WDCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static WDCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static WDCDateTimeConverter dateTimeConverter = new WDCStandardDateTimeConverter();

    public WDCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public WDCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new WDCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=WDCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,WDCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=WDCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
